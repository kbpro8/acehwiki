...
tags: [concept, administrative-division, sagi, groot-atjeh, indigenous-governance, atjeh, sultanate, achehnese, acheh, administrative, territorial, federation, institution, division, three-sagi, colonial]
---
...
## Relationship to Javanese Administrative Structure


The sagi system was a key element of the indigenous administrative structure in the rechtstreeks bestuurd gebied (directly ruled territory) of Atjeh. When Regeeringscommissaris [[S. de Graaff]] asked what indigenous institutions existed in Atjeh comparable to Palembang's marga's, Gouverneur Swart explained the three-tier hierarchy of sagi-peleebalang-moekim, establishing an explicit analogy with the well-known Javanese administrative structure. This comparison was strategically significant: by framing the Atjeh administrative system in terms familiar from Java—the regentschap, the district, and the onderdistrict—Swart was able to demonstrate that Atjeh possessed a governance framework that was not only organized but potentially capable of further development along lines already proven in other parts of the Netherlands East Indies.

The analogy with Java was not exact, however, and the differences were as instructive as the similarities. The Javanese regentschap was rooted in a long tradition of hierarchical governance under the bupati system, which the Dutch had adapted and incorporated into their colonial administrative structure since the days of Raffles and Daendels. The sagi, by contrast, emerged from a more fragmented and competitive political environment, where the authority of the sultan had been balanced against that of regional power-holders. The panglima sagi were not simply indigenous equivalents of the Javanese bupati; their authority derived from different sources and operated within different constraints. Nevertheless, the structural parallel that Swart drew was sufficiently compelling to support his argument that Inlandsche bestuurskrachten (Native administrative forces) could be trained and developed in Atjeh within a reasonable timeframe.

## Implications for Head Appointments


The sagi system also had implications for the question of erfelijkheid (heredity) in head appointments. Swart explained that while heredity existed, it was increasingly being set aside in favor of bekwaamheden (competence) as the decisive factor, and the population was heard but their recommendations could be overridden if the rechthebbende (claimant) lacked required qualifications. This shift was particularly significant at the sagi level, where the stakes of appointment were highest and the potential consequences of installing an incompetent leader were most severe. The gradual move away from strict hereditary succession reflected both the colonial administration's desire for more effective indigenous governance and the practical realities of administering a territory where military conflict had disrupted traditional succession patterns.
...
**The Sagi** — *side* — was the principal territorial division of [[Groot-Atjeh|Groot-Atjeh]], arising when the Atjehnese represented themselves as a triangle and spoke of the *drie sagi* — the three *sagi* or sections. In each *sagi* was a *sagi*-head; under him the *[[Oeléebalang|oeléebalangs]]*; under these the *[[Imeum|imeums]]*. The *onderafdeeling* [[Seulimeum|Seulimeum]] is the *sagi der 22 moekims*; the 25 and 26 *moekims* form the *onderafdeeling* [[Lho' Nga|Lho' Nga]]. The *sagi*-division is the principal territorial framework of the old Atjehnese sultanate, and is described in the work of [[Dr. Snouck Hurgronje|Snouck Hurgronje]].

### Source


*Verkenningen in Atjeh*, by Dr. R. Broersma (De Locomotief, October 1923), chapter XV, *'Groot-Atjeh'*, p. 101.
