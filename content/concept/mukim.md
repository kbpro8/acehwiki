...
When a number of gampongs lay sufficiently close to one another to admit of their being united into a single Friday association in accordance with the behests of Islamic law, they constructed a [[Meusigit|mosque]] (*meusigit* / *meunasah*), choosing the most central possible site. This might fall within one of the gampongs so united, or in a place lying without all the gampong enclosures. For some of these associations the term "district" would be the most applicable name; for others, whose gampongs rather resembled "wards," the term "parish" corresponded most exactly — this being the comparison drawn by [[R. J. Wilkinson|R.J. Wilkinson]] and adopted also in [[Penang]] and Province Wellesley under British administration.

## Religious origin

The institution arose, the source explains, once Islam had taken root in Atjeh. The Shafiʿite school — "ook in Atjeh gehuldigd" — required for the Friday service the presence of at least forty (modified in Atjehsche practice to forty-four) "mannelijke, vrije, meerderjarige moekims" — male, free, adult congregants. To meet this requirement, heads who sought the support of the clergy — "hoofden die den steun van de geestelijkheid zochten en soms vrome rijke lieden" — saw to it that a *meuseugit* was built "op een centraalpunt" for several neighbouring gampongs (originally as a rule four), so that the prescribed number of worshippers could assemble within the lawful walking distance. The word *moekim* itself means only "ingezetene" — inhabitant — but it came to denote the entire congregational district.

## The Imeum Mukim

The head of the mukim was the **[[Imeum Mukim]]** (*imeum*, from Arabic *imam*), who administered the secular as well as religious affairs of the mukim. He was the link between the [[Keuchi'|keuchi']] (village headman) below and the [[Uleebalang|uleebalang]] above, and was responsible for the maintenance of order across all the gampongs in his mukim. The *imeum*'s original task was "eene geheel of grootendeels godsdienstige taak" — wholly or mostly religious: ensuring that Allah's law was upheld and the ritual prescriptions of Islam observed, doing for the *meuseugit* what the [[Teungku|Teungkoe meunasah]] did for the village prayer-house.

Yet the institution soon degenerated — "het ambt der Imeums spoedig geheel ontaard" — as imeums strove "om over de gampongs, die tot hun Vrijdagskring behoorden, overal de macht van een oelèëbalang toe te eigenen." Many became "adathoofden zonder eenig godsdienstig karakter" — adat chiefs without any religious character — and some "hebben het zelfs geheel tot de zelfstandigheid gebracht" — achieved full independence from the [[Uleebalang|oelèëbalang]]. Originally the religious leader (Arab. *imam*) of the Friday service, the *imeum* later became a hereditary secular head ("Oelèëbalang tjout") without religious character. By Kreemer's time, *imeum*'s were *adathoofden* (customary heads) subordinate to Oelèëbalang's or independent; there were ~58 imeum's in Groot Atjèh plus 22 independent.
...
The three *sagi*'s of [[Groot-Atjeh|Groot Atjèh]] were named for their number of moekim's:

1. **[[XXII Mukims|XXII Moekim's]]** ("Twenty-two Moekim's")
2. **[[XXV Mukims|XXV Moekim's]]** ("Twenty-five Moekim's")
3. **[[XXVI Mukims|XXVI Moekim's]]** ("Twenty-six Moekim's")

## Evolution into administrative units

Originally religious-ecclesiastical units, the *moekim*'s evolved into administrative *bestuursressorten* (administrative districts). This evolution is the institutional embodiment of the broader Acehnese pattern by which religious-ecclesiastical offices were progressively absorbed into the adat-administrative order.
...
Some moekim's were *wakeuëh*-districts (free-lordly domains) whose chiefs were withdrawn from the authority of the sagi-heads. Examples: in the XXV Moekim's — Loeëng Bata, Pagar Ajé, Lam Sajoen; in the XXII Moekim's — the III Moekim's Keureukön; in the XXVI Moekim's — Lho' Goelöng, Tjadé' Mön Batèë, Koeala Gigiëng (the latter now no longer existing).

## Use of the Term Elsewhere

[[R. J. Wilkinson|R.J. Wilkinson]] noted that in [[Penang]] and Province Wellesley the English Government had adopted the word *mukim* to designate the minor subdivisions of a district for administrative purposes — corresponding almost exactly to "parish." In the Federated Malay States the word had the same modified meaning as in Acheh. The word *mukim* in Kedah bore the same modified meaning as in Acheh. Newbold (*British Settlements in the Straits of Malacca* II:20) observed that in the former place each mukim consisted originally of at least 44 families, a clear indication of the original intent of this territorial subdivision.
