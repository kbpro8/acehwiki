...
A small but significant difference between the Achehnese and the Javanese custom is the manner in which the dish is consecrated. In Acheh, the *kanji Ashura* is not cooked in every separate house; "one or two large pots full suffice for a whole *gampong*. Those who undertake the cooking receive voluntary subscriptions from their fellow-villagers." The mess is brought to the *meunasah* or sometimes to the junction of the *gampong*-path with the main road. All who wish fall to and gormandize, "generally to such an extent as to cause indigestion. The blessing of the *bubur* by a prayer, though common in Java, is not customary in Acheh. In neither country is the feast strictly limited to the 10th of the month, but often extends some days beyond." The blessing of the bubur in Java is the formal consecration of the dish by a religious formula; its absence in Acheh is one of the marks of the more sober, less ceremonial character of Achehnese Islam.

## The survival of an old commemoration
