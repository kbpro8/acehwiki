...
## Cultural and Legal Comparisons with Acheh

Snouck Hurgronje repeatedly contrasts Javanese and Achehnese customs. The Javanese **pesantrens** and **pondoks** are compared with Achehnese **rangkangs**, while the Javanese methods of religious instruction (*bandungan* and *sorogan*) are set against Achehnese pedagogical practices. Javanese **primbons** (memorandum‑books) are likened to Achehnese mystical manuals, and the Javanese **wayang** theatre is juxtaposed with Achehnese **sadati** performances. In the Hikayat [[Malem Diwa]], the hero drifts to Java after being swallowed by a whale, illustrating Java’s narrative prominence.

Family law provides a striking example. In Java the *ta'liq* marriage contract—allowing a husband to divorce his wife under conditions favourable to her—was historically ordained by rulers of the Mataram kingdom and attributed to Sultan Ageng in places such as [[Chirbon]] and [[Banten]]. Acheh, by contrast, lacks the *ta'liq*. Marriage officials in Java are called *naib* or district *pangulus* (with subordinates *ketip*), whereas in Acheh they are known as *teungku meunasah*. Snouck Hurgronje argues that these divergences demonstrate the patchwork nature of “Mohammedan law” across the archipelago.

Javanese vocabulary also filtered into Achehnese usage: the sweetmeat *peunajah*, the rice‑steaming utensil *kukisan* (re‑appearing as *punchcue'*), and prayer‑house terms (*langgar*, *bale'*, *tajug*) all have Javanese counterparts. The noisy litany *ratib Samman*, named after a saint of [[Medina]], is heard weekly in many Batavian kampongs, and Javanese month‑names (*Apit*, *Sila*, *Longtang*, *Sura*, etc.) recur in Acheh with local modifications. The Javanese legend of the Kalangs finds an Achehnese analogue in the myth of the origin of the inhabitants of [[Nias]].

Legal historian L. W. C. Van den Berg warned against treating these customs as immutable; he argued that Hindu‑influenced law‑books in Java were quickly supplanted by Mohammedan codes, a caution Snouck Hurgronje applies to Acheh’s *Adat Meukuta Alam*.

## Colonial Administration and Strategic Role

After the establishment of [[Batavia]] in [[1619]], the Dutch East India Company (VOC) administered Java as the centre of its Asian trade network. The island’s shipyards, warehouses, and the [[Kweekschool voor de Zeevaart]] (founded [[1774]]) supplied vessels and trained personnel for expeditions such as the [[1784]] fleet under [[Jacob Pieter van Braam]] that sailed from the Texel to Batavia before proceeding to the Aceh‑Riau theatre. Java’s ports facilitated the movement of troops, marines, and supplies to the Aceh frontier, and the colonial government in Batavia coordinated diplomatic missions, military reinforcements, and trade negotiations with the Acehnese sultanate from this administrative hub.
...
In the late [[1820s]] the Dutch reduced the export price of **Java salt** from 70 to 30 rupees per coyan. [[John Prince|Prince]], former resident of [[Singapore]], reported from [[Batavia]] on [[29 November]] [[1827]] that the measure was a deliberate step in a Dutch economic war against Singapore, intended to divert trade from the East Coast of Sumatra to the Dutch‑controlled **Rhio** (Riouw). Van der Kemp, however, argued that the price cut was meant to keep Java salt competitive with Siamese, Makassarese, and Bimanese salt on the Dutch overseas possessions, not a hostile act toward Singapore. The Dutch government at [[Padang]] also complained that Siamese salt imported via Singapore was undercutting Java‑salt sales in Padang.

## The Dipo Negoro Revolt and Its Strategic Context
